...
/*
	...
	Description: This file is part of the Q2A Spanish (Spain) Translation
	Author: Dario Minnucci https://gitlab.com/midget/q2a-translation-es-ES
	...
	More about this license: https://gitlab.com/midget/q2a-translation-es-ES/blob/master/LICENSE
*/
	...
	return array(
		...
		'confirm_body' => "Por favor, pulsa el enlace siguiente para confirmar tu dirección de email en ^site_title.\n\n^url\n\nGracias, \n^site_title",
		'confirm_subject' => '^site_title - Confirmación de dirección de email',
		'feedback_body' => "Comentarios:\n^message\n\nNombre:\n^name\n\nDirección de email:\n^email\n\nPágina anterior:\n^previous\n\nUsuario:\n^url\n\nDirección IP:\n^ip\n\nNavegador:\n^browser",
		'feedback_subject' => '^ feedback',
		'flagged_body' => "Una publicación de ^p_handle ha recibido ^flags:\n\n^open^p_context^close\n\nPulsa el siguiente enlace para ver la publicación:\n\n^url\n\n\nPulsa el siguiente enlace para revisar todas las publicaciones marcadas:\n\n^a_url\n\n\nGracias,\n\n^site_title",
		'flagged_subject' => '^site_title tiene una publicación marcada',
		'moderate_body' => "Una entrada de ^p_handle requiere tu aprobación:\n\n^open^p_context^close\n\nPulsa el siguiente enlace para aprobar o rechazar la entrada:\n\n^url\n\n\nPulsa el siguiente enlace para revisar todas las entradas encoladas:\n\n^a_url\n\n\nGracias,\n\n^site_title",
		'moderate_subject' => 'Moderación de ^site_title',
		'new_password_body' => "Tu nueva contraseña para ^site_title es la siguiente.\n\nContraseña: ^password\n\nTe recomendamos que cambies esta contraseña inmendiatamente después de acceder al sitio web.\n\nGracias, \n^site_title\n^url",
		...
		'private_message_reply' => "Pulsa el siguiente enlace para contestar a ^f_handle por mensaje privado:\n\n^url\n\n",
